                              ...
                              nDesign = 1)
{
    ...
    #ISA Start Times - Create a list where the first ISA starts at time 0 and ISA 2 & 3 start
    # at a random time between the time provided in vISAStartTimes and 3 months 
    lISAStart   <- list( structure( list( dParam1 = vISAStartTimes[ 1 ] ), class="SetTime" ),
                         structure( list( dParam1 = vISAStartTimes[ 2 ], dParam2=vISAStartTimes[ 2 ] + 3), class="Uniform" ),
                         structure( list( dParam1 = vISAStartTimes[ 3 ], dParam2=vISAStartTimes[ 3 ] + 3), class="Uniform" )
                         )
    ...
    #
    vPatsPerMonthPerSite1   <- c(0.1, 0.3,  0.45, 0.5, 0.5, 0.5, 0.5, 0.5 )
    vQtyOfSitesPlat         <- c(3,     8,  15,   25,  30,   35, 60, 70)
    ...
    vTrueRespRateTrt <- c( 0.3, 0.35, 0.4, 0.5 )  #This vector is used in the loop below
