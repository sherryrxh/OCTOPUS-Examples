...
# 2nd ISA enters platform at month 6, with a sample size of 25 on control and 125 on treatment (see the mQtyPats definition and vISAStartTImes )
...
strProjName                <- "CategoricalOutcome"
strAnalysis                <- "CategoricalAnalysis"
strSimPatOutcome           <- "Categorical"
